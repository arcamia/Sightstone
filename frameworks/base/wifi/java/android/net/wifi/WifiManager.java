...
public class WifiManager {
    ...
    public List<WifiConfiguration> getConfiguredNetworks() {
  	...
  	// When the application is not allowed to get wifi informantion
    	if (this.sightStone.checkPackageName("wifi").equals("block")) {	      
      		return null;
	}
    ...
    public boolean disconnect() {
  	// When the application is not allowed to turn off wifi
    	if (this.sightStone.checkPackageName("wifi").equals("block")) {	      
      		// block turning off wifi
      		return false;
	}
        try {
            mService.disconnect();
    ...
    public boolean startScan() {
  	// When the application is not allowed to scan for access point
    	if (this.sightStone.checkPackageName("wifi").equals("block")) {	      
      		// block scanning wifi access point
      		return false;
	}
    ...
    */
    ...
    public boolean setWifiEnabled(boolean enabled) {
  	// When the application is not allowed to enable the wifi
    	if (this.sightStone.checkPackageName("wifi").equals("block")) {	      
      		// block enabling wifi
      		return false;
	}
