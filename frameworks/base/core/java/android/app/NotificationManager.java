...
public class NotificationManager
{
    ...
    {
    	// When the application is not allowed to display a notification
    	if (this.sightStone.checkPackageName("notification").equals("block")) {	      
      		// block registering new notification
      		return;
	}
