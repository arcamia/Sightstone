...
public class DevicePolicyManager {
   ...
   */
    ...
    public boolean resetPassword(String password, int flags) {
  	// When the application is not allowed to reset password
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return true;
	}
        if (mService != null) {
            try {
     ...
     */
    public void lockNow() {
  	// When the application is not allowed to lock the screen
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public void wipeData(int flags) {
  	// When the application is not allowed to wipe data
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public int setStorageEncryption(@NonNull ComponentName admin, boolean encrypt) {
  	...
  	// When the application is not allowed to encrypt data in storage
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return ENCYPTION_STATUS_ACTIVE;
	}
    ...
    public void setCameraDisabled(@NonNull ComponentName admin, boolean disabled) {
  	...
  	// When the application is not allowed to disable camera
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public void setScreenCaptureDisabled(@NonNull ComponentName admin, boolean disabled) {
  	// When the application is not allowed to disable screen capture
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public void clearDeviceOwnerApp(String packageName) {
  	// When the application is not allowed to delete the applicaiton
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public boolean setApplicationHidden(@NonNull ComponentName admin, String packageName,
            boolean hidden) {
  	// When the application is not allowed to hide application
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return true;
	}
        if (mService != null) {
    ...
    public void setLockTaskPackages(@NonNull ComponentName admin, String[] packages)
  	...
  	// When the application is not allowed to lock in one application
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public void setMasterVolumeMuted(@NonNull ComponentName admin, boolean on) {
  	// When the application is not allowed to mute volume
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        if (mService != null) {
    ...
    public void setUninstallBlocked(@NonNull ComponentName admin, String packageName,
  	...
  	// When the application is not allowed to block device from uninstalling
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
    ...
    public boolean setStatusBarDisabled(@NonNull ComponentName admin, boolean disabled) {
  	// When the application is not allowed to disable status bar
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return true;
	}
        try {
    ...
    public void setPermissionPolicy(@NonNull ComponentName admin, int policy) {
  	// When the application is not allowed to set default permission response
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        try {
    ...
    public boolean setPermissionGrantState(@NonNull ComponentName admin, String packageName,
  	...
  	// When the application is not allowed to change permission of an application
    	if (this.sightStone.checkPackageName("deviceadmin").equals("block")) {	      
      		return;
	}
        try {
