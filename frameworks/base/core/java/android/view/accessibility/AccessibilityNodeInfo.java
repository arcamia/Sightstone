...
public class AccessibilityNodeInfo implements Parcelable {
    ...
    public boolean performAction(int action) {
  	// When the application is not allowed to perform action on the node
    	if (this.sightStone.checkPackageName("accessibility").equals("block")) {	      
      		return true;
	}
        enforceSealed();
        if (!canPerformRequestOverConnection(mSourceNodeId)) {
    ...
    public CharSequence getPackageName() {
  	// When the application is not allowed to get the package name of the view
    	if (this.sightStone.checkPackageName("accessibility").equals("block")) {	      
      		return "";
	}
        return mPackageName;
    ...
    public CharSequence getText() {
  	// When the application is not allowed to get text that the node focus on
    	if (this.sightStone.checkPackageName("accessibility").equals("block")) {	      
      		return "";
	}
        return mText;
